...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PrizesState<T>);
}
...
/// @nodoc
class $PrizesStateCopyWith<T,$Res>  {
$PrizesStateCopyWith(PrizesState<T> _, $Res Function(PrizesState<T>) __);
}


/// Adds pattern-matching-related methods to [PrizesState].
extension PrizesStatePatterns<T> on PrizesState<T> {
...
class _Initial<T> implements PrizesState<T> {
  const _Initial();
...
class Loading<T> implements PrizesState<T> {
  const Loading();
...
class Success<T> implements PrizesState<T> {
...
@override
String toString() {
  return 'PrizesState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $PrizesStateCopyWith<T, $Res> {
...
class Error<T> implements PrizesState<T> {
...
@override
String toString() {
  return 'PrizesState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $PrizesStateCopyWith<T, $Res> {
