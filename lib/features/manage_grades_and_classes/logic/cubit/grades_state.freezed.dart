...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GradesState<T>);
}
...
/// @nodoc
class $GradesStateCopyWith<T,$Res>  {
$GradesStateCopyWith(GradesState<T> _, $Res Function(GradesState<T>) __);
}


/// Adds pattern-matching-related methods to [GradesState].
extension GradesStatePatterns<T> on GradesState<T> {
...
class _Initial<T> implements GradesState<T> {
  const _Initial();
...
class Loading<T> implements GradesState<T> {
  const Loading();
...
class Success<T> implements GradesState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of GradesState
...
@override
String toString() {
  return 'GradesState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $GradesStateCopyWith<T, $Res> {
...
class Error<T> implements GradesState<T> {
...
@override
String toString() {
  return 'GradesState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $GradesStateCopyWith<T, $Res> {
