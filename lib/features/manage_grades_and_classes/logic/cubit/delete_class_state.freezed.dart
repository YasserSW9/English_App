...
part of 'delete_class_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteClassState<T>);
}
...
/// @nodoc
class $DeleteClassStateCopyWith<T,$Res>  {
$DeleteClassStateCopyWith(DeleteClassState<T> _, $Res Function(DeleteClassState<T>) __);
}


/// Adds pattern-matching-related methods to [DeleteClassState].
extension DeleteClassStatePatterns<T> on DeleteClassState<T> {
...
class _Initial<T> implements DeleteClassState<T> {
  const _Initial();
...
@override
String toString() {
  return 'DeleteClassState<$T>.initial()';
}
...
class Loading<T> implements DeleteClassState<T> {
  const Loading();
...
@override
String toString() {
  return 'DeleteClassState<$T>.loading()';
}
...
class Success<T> implements DeleteClassState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of DeleteClassState
...
@override
String toString() {
  return 'DeleteClassState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DeleteClassStateCopyWith<T, $Res> {
...
class Error<T> implements DeleteClassState<T> {
...
@override
String toString() {
  return 'DeleteClassState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DeleteClassStateCopyWith<T, $Res> {
