...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateClassState<T>);
}
...
/// @nodoc
class $CreateClassStateCopyWith<T,$Res>  {
$CreateClassStateCopyWith(CreateClassState<T> _, $Res Function(CreateClassState<T>) __);
}


/// Adds pattern-matching-related methods to [CreateClassState].
extension CreateClassStatePatterns<T> on CreateClassState<T> {
...
class _Initial<T> implements CreateClassState<T> {
  const _Initial();
...
@override
String toString() {
  return 'CreateClassState<$T>.initial()';
}
...
class Loading<T> implements CreateClassState<T> {
  const Loading();
...
@override
String toString() {
  return 'CreateClassState<$T>.loading()';
}
...
class Success<T> implements CreateClassState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of CreateClassState
...
@override
String toString() {
  return 'CreateClassState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CreateClassStateCopyWith<T, $Res> {
...
class Error<T> implements CreateClassState<T> {
...
@override
String toString() {
  return 'CreateClassState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CreateClassStateCopyWith<T, $Res> {
