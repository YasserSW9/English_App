...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditClassState<T>);
}
...
/// @nodoc
class $EditClassStateCopyWith<T,$Res>  {
$EditClassStateCopyWith(EditClassState<T> _, $Res Function(EditClassState<T>) __);
}


/// Adds pattern-matching-related methods to [EditClassState].
extension EditClassStatePatterns<T> on EditClassState<T> {
...
class _Initial<T> implements EditClassState<T> {
  const _Initial();
...
@override
String toString() {
  return 'EditClassState<$T>.initial()';
}
...
class Loading<T> implements EditClassState<T> {
  const Loading();
...
@override
String toString() {
  return 'EditClassState<$T>.loading()';
}
...
class Success<T> implements EditClassState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of EditClassState
...
@override
String toString() {
  return 'EditClassState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $EditClassStateCopyWith<T, $Res> {
...
class Error<T> implements EditClassState<T> {
...
@override
String toString() {
  return 'EditClassState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $EditClassStateCopyWith<T, $Res> {
