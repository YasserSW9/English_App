...
part of 'create_grades_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateGradesState<T>);
}
...
/// @nodoc
class $CreateGradesStateCopyWith<T,$Res>  {
$CreateGradesStateCopyWith(CreateGradesState<T> _, $Res Function(CreateGradesState<T>) __);
}


/// Adds pattern-matching-related methods to [CreateGradesState].
extension CreateGradesStatePatterns<T> on CreateGradesState<T> {
...
class _Initial<T> implements CreateGradesState<T> {
  const _Initial();
...
@override
String toString() {
  return 'CreateGradesState<$T>.initial()';
}
...
class Loading<T> implements CreateGradesState<T> {
  const Loading();
...
@override
String toString() {
  return 'CreateGradesState<$T>.loading()';
}
...
class Success<T> implements CreateGradesState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of CreateGradesState
...
@override
String toString() {
  return 'CreateGradesState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CreateGradesStateCopyWith<T, $Res> {
...
class Error<T> implements CreateGradesState<T> {
...
@override
String toString() {
  return 'CreateGradesState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CreateGradesStateCopyWith<T, $Res> {
