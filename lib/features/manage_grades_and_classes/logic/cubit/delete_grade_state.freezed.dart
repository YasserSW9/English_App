...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteGradeState<T>);
}
...
/// @nodoc
class $DeleteGradeStateCopyWith<T,$Res>  {
$DeleteGradeStateCopyWith(DeleteGradeState<T> _, $Res Function(DeleteGradeState<T>) __);
}


/// Adds pattern-matching-related methods to [DeleteGradeState].
extension DeleteGradeStatePatterns<T> on DeleteGradeState<T> {
...
class _Initial<T> implements DeleteGradeState<T> {
  const _Initial();
...
class Loading<T> implements DeleteGradeState<T> {
  const Loading();
...
class Success<T> implements DeleteGradeState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of DeleteGradeState
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DeleteGradeStateCopyWith<T, $Res> {
...
class Error<T> implements DeleteGradeState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DeleteGradeStateCopyWith<T, $Res> {
