...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditGradeState<T>);
}
...
/// @nodoc
class $EditGradeStateCopyWith<T,$Res>  {
$EditGradeStateCopyWith(EditGradeState<T> _, $Res Function(EditGradeState<T>) __);
}


/// Adds pattern-matching-related methods to [EditGradeState].
extension EditGradeStatePatterns<T> on EditGradeState<T> {
...
class _Initial<T> implements EditGradeState<T> {
  const _Initial();
...
class Loading<T> implements EditGradeState<T> {
  const Loading();
...
class Success<T> implements EditGradeState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of EditGradeState
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $EditGradeStateCopyWith<T, $Res> {
...
class Error<T> implements EditGradeState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $EditGradeStateCopyWith<T, $Res> {
