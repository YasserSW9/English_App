...
import 'package:english_app/features/manage_grades_and_classes/logic/cubit/delete_class_cubit.dart'; // إضافة هذا السطر
import 'package:english_app/features/manage_grades_and_classes/logic/cubit/delete_class_state.dart'; // إضافة هذا السطر
...
class GradeAndSectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<DeleteClassCubit, DeleteClassState>(
        ...
        state.whenOrNull(
          success: (data) {
            AwesomeDialog(
              ...
              title: 'Success',
              desc: 'Class has been deleted successfully.',
              btnOkOnPress: () {},
            ).show();
          },
          error: (error) {
              ...
              InkWell(
                onTap: () {
                  ...
                  AwesomeDialog(
                    ...
                    btnCancelText: 'Cancel',
                    btnOkOnPress: () {
                      final String className = newClassNameController.text
                          .trim();
                    ...
                    confirmDismiss: (direction) async {
                      if (direction == DismissDirection.startToEnd) {
                        AwesomeDialog(
                          ...
                          btnCancelText: 'Cancel',
                          btnOkOnPress: () {
                            // استدعاء الـ cubit لحذف الفصل
                            context.read<DeleteClassCubit>().emitDeleteClass(
                              classId: sections[sectionIndex].id.toString(),
                            );
                          },
                        ).show();
                        // نرجع false لمنع الإزالة التلقائية للقائمة
                        // وسنتعامل مع إزالة العنصر من الـ UI داخل BlocListener
                        return false;
