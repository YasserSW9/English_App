...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StoryState<T>);
}
...
/// @nodoc
class $StoryStateCopyWith<T,$Res>  {
$StoryStateCopyWith(StoryState<T> _, $Res Function(StoryState<T>) __);
}


/// Adds pattern-matching-related methods to [StoryState].
extension StoryStatePatterns<T> on StoryState<T> {
...
class _Initial<T> implements StoryState<T> {
  const _Initial();
...
class Loading<T> implements StoryState<T> {
  const Loading();
...
class Success<T> implements StoryState<T> {
...
@override
String toString() {
  return 'StoryState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $StoryStateCopyWith<T, $Res> {
...
class Error<T> implements StoryState<T> {
...
@override
String toString() {
  return 'StoryState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $StoryStateCopyWith<T, $Res> {
