...
part of 'collect_tasks_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CollectTasksState<T>);
}
...
/// @nodoc
class $CollectTasksStateCopyWith<T,$Res>  {
$CollectTasksStateCopyWith(CollectTasksState<T> _, $Res Function(CollectTasksState<T>) __);
}


/// Adds pattern-matching-related methods to [CollectTasksState].
extension CollectTasksStatePatterns<T> on CollectTasksState<T> {
...
class _Initial<T> implements CollectTasksState<T> {
  const _Initial();
...
@override
String toString() {
  return 'CollectTasksState<$T>.initial()';
}
...
class Loading<T> implements CollectTasksState<T> {
  const Loading();
...
@override
String toString() {
  return 'CollectTasksState<$T>.loading()';
}
...
class Success<T> implements CollectTasksState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of CollectTasksState
...
@override
String toString() {
  return 'CollectTasksState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CollectTasksStateCopyWith<T, $Res> {
...
class Error<T> implements CollectTasksState<T> {
...
@override
String toString() {
  return 'CollectTasksState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CollectTasksStateCopyWith<T, $Res> {
