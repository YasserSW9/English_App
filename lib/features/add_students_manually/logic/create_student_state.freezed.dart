...
part of 'create_student_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateStudentState<T>);
}
...
/// @nodoc
class $CreateStudentStateCopyWith<T,$Res>  {
$CreateStudentStateCopyWith(CreateStudentState<T> _, $Res Function(CreateStudentState<T>) __);
}


/// Adds pattern-matching-related methods to [CreateStudentState].
extension CreateStudentStatePatterns<T> on CreateStudentState<T> {
...
class _Initial<T> implements CreateStudentState<T> {
  const _Initial();
...
@override
String toString() {
  return 'CreateStudentState<$T>.initial()';
}
...
class Loading<T> implements CreateStudentState<T> {
  const Loading();
...
@override
String toString() {
  return 'CreateStudentState<$T>.loading()';
}
...
class Success<T> implements CreateStudentState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of CreateStudentState
...
@override
String toString() {
  return 'CreateStudentState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CreateStudentStateCopyWith<T, $Res> {
...
class Error<T> implements CreateStudentState<T> {
...
@override
String toString() {
  return 'CreateStudentState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CreateStudentStateCopyWith<T, $Res> {
