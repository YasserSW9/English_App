...
part of 'delete_admin_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteAdminState<T>);
}
...
/// @nodoc
class $DeleteAdminStateCopyWith<T,$Res>  {
$DeleteAdminStateCopyWith(DeleteAdminState<T> _, $Res Function(DeleteAdminState<T>) __);
}


/// Adds pattern-matching-related methods to [DeleteAdminState].
extension DeleteAdminStatePatterns<T> on DeleteAdminState<T> {
...
class _Initial<T> implements DeleteAdminState<T> {
  const _Initial();
...
@override
String toString() {
  return 'DeleteAdminState<$T>.initial()';
}
...
class Loading<T> implements DeleteAdminState<T> {
  const Loading();
...
@override
String toString() {
  return 'DeleteAdminState<$T>.loading()';
}
...
class Success<T> implements DeleteAdminState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of DeleteAdminState
...
@override
String toString() {
  return 'DeleteAdminState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DeleteAdminStateCopyWith<T, $Res> {
...
class Error<T> implements DeleteAdminState<T> {
...
@override
String toString() {
  return 'DeleteAdminState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DeleteAdminStateCopyWith<T, $Res> {
