...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminState<T>);
}
...
/// @nodoc
class $AdminStateCopyWith<T,$Res>  {
$AdminStateCopyWith(AdminState<T> _, $Res Function(AdminState<T>) __);
}


/// Adds pattern-matching-related methods to [AdminState].
extension AdminStatePatterns<T> on AdminState<T> {
...
class _Initial<T> implements AdminState<T> {
  const _Initial();
...
class Loading<T> implements AdminState<T> {
  const Loading();
...
class Success<T> implements AdminState<T> {
...
@override
String toString() {
  return 'AdminState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AdminStateCopyWith<T, $Res> {
...
class Error<T> implements AdminState<T> {
...
@override
String toString() {
  return 'AdminState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AdminStateCopyWith<T, $Res> {
