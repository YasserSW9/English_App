...
part of 'delete_student_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteStudentState<T>);
}
...
/// @nodoc
class $DeleteStudentStateCopyWith<T,$Res>  {
$DeleteStudentStateCopyWith(DeleteStudentState<T> _, $Res Function(DeleteStudentState<T>) __);
}


/// Adds pattern-matching-related methods to [DeleteStudentState].
extension DeleteStudentStatePatterns<T> on DeleteStudentState<T> {
...
class _Initial<T> implements DeleteStudentState<T> {
  const _Initial();
...
@override
String toString() {
  return 'DeleteStudentState<$T>.initial()';
}
...
class Loading<T> implements DeleteStudentState<T> {
  const Loading();
...
@override
String toString() {
  return 'DeleteStudentState<$T>.loading()';
}
...
class Success<T> implements DeleteStudentState<T> {
...
@override
String toString() {
  return 'DeleteStudentState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DeleteStudentStateCopyWith<T, $Res> {
...
class Error<T> implements DeleteStudentState<T> {
...
@override
String toString() {
  return 'DeleteStudentState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DeleteStudentStateCopyWith<T, $Res> {
