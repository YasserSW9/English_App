...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditStudentState<T>);
}
...
/// @nodoc
class $EditStudentStateCopyWith<T,$Res>  {
$EditStudentStateCopyWith(EditStudentState<T> _, $Res Function(EditStudentState<T>) __);
}


/// Adds pattern-matching-related methods to [EditStudentState].
extension EditStudentStatePatterns<T> on EditStudentState<T> {
...
class _Initial<T> implements EditStudentState<T> {
  const _Initial();
...
class Loading<T> implements EditStudentState<T> {
  const Loading();
...
class Success<T> implements EditStudentState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of EditStudentState
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $EditStudentStateCopyWith<T, $Res> {
...
class Error<T> implements EditStudentState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $EditStudentStateCopyWith<T, $Res> {
