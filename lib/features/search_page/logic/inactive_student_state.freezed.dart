...
part of 'inactive_student_state.dart';
...
/// @nodoc
mixin _$InactiveStudentState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InactiveStudentState<T>);
}
...
/// @nodoc
class $InactiveStudentStateCopyWith<T,$Res>  {
$InactiveStudentStateCopyWith(InactiveStudentState<T> _, $Res Function(InactiveStudentState<T>) __);
}


/// Adds pattern-matching-related methods to [InactiveStudentState].
extension InactiveStudentStatePatterns<T> on InactiveStudentState<T> {
...
class _Initial<T> implements InactiveStudentState<T> {
  const _Initial();
...
@override
String toString() {
  return 'InactiveStudentState<$T>.initial()';
}
...
class Loading<T> implements InactiveStudentState<T> {
  const Loading();
...
@override
String toString() {
  return 'InactiveStudentState<$T>.loading()';
}
...
class Success<T> implements InactiveStudentState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of InactiveStudentState
...
@override
String toString() {
  return 'InactiveStudentState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $InactiveStudentStateCopyWith<T, $Res> {
...
class Error<T> implements InactiveStudentState<T> {
...
@override
String toString() {
  return 'InactiveStudentState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $InactiveStudentStateCopyWith<T, $Res> {
