...
part of 'delete_sub_level_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteSubLevelState<T>);
}
...
/// @nodoc
class $DeleteSubLevelStateCopyWith<T,$Res>  {
$DeleteSubLevelStateCopyWith(DeleteSubLevelState<T> _, $Res Function(DeleteSubLevelState<T>) __);
}


/// Adds pattern-matching-related methods to [DeleteSubLevelState].
extension DeleteSubLevelStatePatterns<T> on DeleteSubLevelState<T> {
...
class _Initial<T> implements DeleteSubLevelState<T> {
  const _Initial();
...
@override
String toString() {
  return 'DeleteSubLevelState<$T>.initial()';
}
...
class Loading<T> implements DeleteSubLevelState<T> {
  const Loading();
...
@override
String toString() {
  return 'DeleteSubLevelState<$T>.loading()';
}
...
class Success<T> implements DeleteSubLevelState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of DeleteSubLevelState
...
@override
String toString() {
  return 'DeleteSubLevelState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DeleteSubLevelStateCopyWith<T, $Res> {
...
class Error<T> implements DeleteSubLevelState<T> {
...
@override
String toString() {
  return 'DeleteSubLevelState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DeleteSubLevelStateCopyWith<T, $Res> {
