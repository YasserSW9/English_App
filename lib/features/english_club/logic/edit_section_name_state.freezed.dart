...
part of 'edit_section_name_state.dart';
...
/// @nodoc
mixin _$EditSectionNameState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditSectionNameState<T>);
}
...
/// @nodoc
class $EditSectionNameStateCopyWith<T,$Res>  {
$EditSectionNameStateCopyWith(EditSectionNameState<T> _, $Res Function(EditSectionNameState<T>) __);
}


/// Adds pattern-matching-related methods to [EditSectionNameState].
extension EditSectionNameStatePatterns<T> on EditSectionNameState<T> {
...
class _Initial<T> implements EditSectionNameState<T> {
  const _Initial();
...
@override
String toString() {
  return 'EditSectionNameState<$T>.initial()';
}
...
class Loading<T> implements EditSectionNameState<T> {
  const Loading();
...
@override
String toString() {
  return 'EditSectionNameState<$T>.loading()';
}
...
class Success<T> implements EditSectionNameState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of EditSectionNameState
...
@override
String toString() {
  return 'EditSectionNameState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $EditSectionNameStateCopyWith<T, $Res> {
...
class Error<T> implements EditSectionNameState<T> {
...
@override
String toString() {
  return 'EditSectionNameState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $EditSectionNameStateCopyWith<T, $Res> {
