...
part of 'delete_section_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteSectionState<T>);
}
...
/// @nodoc
class $DeleteSectionStateCopyWith<T,$Res>  {
$DeleteSectionStateCopyWith(DeleteSectionState<T> _, $Res Function(DeleteSectionState<T>) __);
}


/// Adds pattern-matching-related methods to [DeleteSectionState].
extension DeleteSectionStatePatterns<T> on DeleteSectionState<T> {
...
class _Initial<T> implements DeleteSectionState<T> {
  const _Initial();
...
@override
String toString() {
  return 'DeleteSectionState<$T>.initial()';
}
...
class Loading<T> implements DeleteSectionState<T> {
  const Loading();
...
@override
String toString() {
  return 'DeleteSectionState<$T>.loading()';
}
...
class Success<T> implements DeleteSectionState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of DeleteSectionState
...
@override
String toString() {
  return 'DeleteSectionState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DeleteSectionStateCopyWith<T, $Res> {
...
class Error<T> implements DeleteSectionState<T> {
...
@override
String toString() {
  return 'DeleteSectionState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DeleteSectionStateCopyWith<T, $Res> {
