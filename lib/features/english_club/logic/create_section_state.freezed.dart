...
part of 'create_section_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateSectionState<T>);
}
...
/// @nodoc
class $CreateSectionStateCopyWith<T,$Res>  {
$CreateSectionStateCopyWith(CreateSectionState<T> _, $Res Function(CreateSectionState<T>) __);
}


/// Adds pattern-matching-related methods to [CreateSectionState].
extension CreateSectionStatePatterns<T> on CreateSectionState<T> {
...
class _Initial<T> implements CreateSectionState<T> {
  const _Initial();
...
@override
String toString() {
  return 'CreateSectionState<$T>.initial()';
}
...
class Loading<T> implements CreateSectionState<T> {
  const Loading();
...
@override
String toString() {
  return 'CreateSectionState<$T>.loading()';
}
...
class Success<T> implements CreateSectionState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of CreateSectionState
...
@override
String toString() {
  return 'CreateSectionState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CreateSectionStateCopyWith<T, $Res> {
...
class Error<T> implements CreateSectionState<T> {
...
@override
String toString() {
  return 'CreateSectionState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CreateSectionStateCopyWith<T, $Res> {
